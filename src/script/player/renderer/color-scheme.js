...
export class ColorScheme {
  constructor(json) {
    ...
    this.gauge[GaugeType.NORMAL].top = color("gauge.normal.top", [255, 127, 0, 1])
    this.gauge[GaugeType.NORMAL].bottom = color("gauge.normal.bottom", [255, 255, 0, 1])
    this.gauge[GaugeType.EASY] = {}
    this.gauge[GaugeType.EASY].top = color("gauge.easy.top", [0, 255, 0, 1])
    this.gauge[GaugeType.EASY].bottom = color("gauge.easy.bottom", [255, 255, 0, 1])
